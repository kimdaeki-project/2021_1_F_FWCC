...
<body id="main">
				...
				<div class="fl-left">
					<h1>
						<a href="/index.html"><span class="logo_bk"><img src="/web/upload/suhon_studio/vol98/logo.png" alt="" /></span><span class="logo_w"><img
								src="/web/upload/suhon_studio/vol98/logo_w.png" alt=""
							/></span></a>
					</h1>
					<div id="category">
						...
						<li><a href="#">Community</a>
							<div class="sub">
								<ul class="xans-element- xans-layout xans-layout-boardinfo">
									...
									<li class="xans-record-"><a href="/board/review/8/">Review</a></li>
								</ul>
							</div></li>
						<li class="xans-element- xans-layout xans-layout-statelogoff "><a href="/member/login.html">Login</a> / <a href="/member/join.html">Join</a></li>
						<li><a href="/myshop/index.html">My Account</a>
							<div class="sub">
								<ul>
									<li><a href="/myshop/order/list.html">ORDER LIST</a></li>
									<li><a href="/member/modify.html">PROFILE</a></li>
									<li><a href="/myshop/wish_list.html">WISHLIST</a></li>
									<li><a href="/product/recent_view_product.html">TODAY VIEW</a></li>
									<li><a href="/myshop/mileage/historyList.html">MILEAGE</a></li>
									<li><a href="/myshop/coupon/coupon.html">COUPON</a></li>
									<li><a href="/myshop/board_list.html">MY BOARD</a></li>
								</ul>
							</div></li>
						<li class="mSearch"><a href="/product/search.html">Search <img src="/web/upload/suhon_studio/vol98/header_ico_search.png" alt="검색" /></a></li>
						<li id="ec_async_basket_layer_hover" class="xans-element- xans-layout xans-layout-orderbasketcount mCart "><a href="/order/basket.html">Cart <span class="count">0</span></a> <!-- 비동기 레이어를 담기위한 컨테이너 -->
						...
						<li>
							<div class="xans-element- xans-layout xans-layout-multishoplist list ">
								...
								<ul class="xans-element- xans-layout xans-layout-multishoplistitem">
									<li class="selected xans-record-"><a href="//frizm.co.kr/"> <img src="//img.cafe24.com/img/common/global/ko_KR_32x24.png" alt="" /> <span class="name">한국어</span> <span class="unit">KRW</span>
									</a></li>
									<li class=" xans-record-"><a href="//en.frizm.co.kr/"> <img src="//img.cafe24.com/img/common/global/en_US_32x24.png" alt="" /> <span class="name">English</span> <span class="unit">USD</span>
									</a></li>
								</ul>
							</div>
						</li>
		...
		<div id="container">
			...
			<div id="footer" class="xans-element- xans-layout xans-layout-footer ">
				<div class="inner">
					...
					<div class="snsLink">
						<a href="http://facebook.com/frizmworks" title="페이스북" target="_blank"><i class="fa fa-facebook fa-lg"></i></a> <a href="http://blog.naver.com/frizmworks" title="블로그" target="_blank"><i
							class="fa fa-bold fa-lg"
						></i></a> <a href="http://instagram.com/frizmworks_official" title="인스타그램" target="_blank"><i class="fa fa-instagram fa-lg"></i></a> <a
							href="https://www.youtube.com/channel/UC4UfMCMlbelhoyaeidXyX-g/featured" title="유튜브" target="_blank"
					...
					<div class="xans-element- xans-layout xans-layout-info cs ">
						<h2>TEL 070.4063.4692</h2>
						<p>OPEN AM 11:00 ~ CLOSE PM 18:00 LUNCH TIME PM 12:00 ~ PM 13:00 WEEKEND/HOLIDAY OFF</p>
						<p>국민은행 802201-00-074363 예금주 : ㈜가먼츠</p>
					</div>

					<div class="footer-info">
						<p>
							<span>COMPANY : 주식회사 가먼츠</span> <span>CEO : 안종혁, 황호준</span> <span>TEL : 070-4063-4692</span> <span>FAX : 031-464-9700</span> <span>ADDRESS : 431060 경기도 안양시 동안구 관양동 1731-1 네이처빌딩 101,102,
								302-2, 402호</span><br />
							<span>BUSINESS LICENSE : 285-88-01438</span> <span>MAIL-ORDER LICENSE : 2020-안양동안-0068 <a href="#none"
								onclick="window.open('http://www.ftc.go.kr/bizCommPop.do?wrkr_no=2858801438', 'bizCommPop', 'width=750, height=950;');return false;"
							>[사업자정보확인]</a></span> <span>PERSONAL INFO MANAGER : 안종혁 </span> <span>E-MAIL : company@garments.co.kr</span>
						</p>
						<p class="copyright">
							COPYRIGHT © FrizmWORKS. ALL RIGHTS RESERVED. Site by <a href="http://www.suhon-studio.co.kr/" target="_blank">suhonstudio</a>
						</p>
					</div>
			...
			<div id="quickmenu">
				<p class="pageTop">
					<a onclick="go_top();"><i class="fa fa-angle-up" aria-hidden="true"></i></a>
				</p>
			</div>
	...
	<div class="xans-element- xans-layout xans-layout-multishopshipping ">
		...
		<div class="worldshipLayer ec-base-layer">
			...
			<div class="content">
				...
				<div class="select">
					<select class="xans-element- xans-layout xans-layout-multishopshippinglanguagelist"><option value="frizm.co.kr" selected="selected" class="xans-record-">LANGUAGE : 한국어</option>
						<option value="en.frizm.co.kr" class="xans-record-">LANGUAGE : English</option>
					</select>
				</div>
			</div>
	...
	<script>
		try {
			...
			if (!wcs_add)
				var wcs_add = {};
			wcs_add["wa"] = "s_2d9c69b2719d";

			// 마일리지 White list가 있을 경우
			wcs.mileageWhitelist = [ "frizm.cafe24.com",
					"www.frizm.cafe24.com", "m.frizm.cafe24.com",
					"frizm.co.kr", "www.frizm.co.kr", "m.frizm.co.kr" ];

			// 네이버 페이 White list가 있을 경우
			wcs.checkoutWhitelist = [ "frizm.cafe24.com",
					"www.frizm.cafe24.com", "m.frizm.cafe24.com",
					"frizm.co.kr", "www.frizm.co.kr", "m.frizm.co.kr" ];

			// 레퍼러 (스크립트 인젠션 공격 대응 strip_tags) ECQAINT-15101
			wcs.setReferer("https://www.google.co.kr/");

			// 유입 추적 함수 호출
			wcs.inflow("frizm.co.kr");
	...
	<div id="fbe_common_top_script" style="display: none;">
		...
		<script>
			if (!window.top.fbe_init_activated) {
				...
				fbq('init', '607802676300294', {}, {
					agent : 'plcafe24_kr'
				});
				fbq('trackSingle', '607802676300294', 'PageView');
				window.top.fbe_init_activated = true;
			}
		</script>
		<noscript>
			<img height="1" width="1" style="display: none" src="https://www.facebook.com/tr?id=607802676300294&ev=PageView&noscript=1" />
		</noscript>
...
<script type="text/javascript" src="/js/ind-script/i18n.php?lang=ko_KR&domain=front&v=2105131222" charset="utf-8"></script>
	...
	<script type="text/javascript">
		...
		var mobileWeb = false;
		var EC_SHOP_MULTISHOP_SHIPPING = {
			"bMultishopShipping" : false,
			"bMultishopShippingCountrySelection" : false,
			"bMultishopShippingLanguageSelection" : false
		};
		var aLogData = {
			"log_server1" : "eclog2-021.cafe24.com",
			"log_server2" : "elg-db-svcm-051.cafe24.com",
			"mid" : "frizm",
			"stype" : "e",
			"domain" : "",
			"shop_no" : "1",
